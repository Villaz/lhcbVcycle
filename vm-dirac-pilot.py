#!/usr/bin/env python
#
# VM copy of dirac-pilot.py from DIRAC_v6r10p20
#
# $HeadURL$
"""
...
installScriptName = 'vm-dirac-install.py'
...
if os.environ.has_key( 'SGE_TASK_ID' ) and os.environ.has_key( 'JOB_ID' ):
...
# Force update of dirac.cfg file on disk
configureOpts.append( '-F' )
...
### Start test of dirac-architecture test
try:
 shutil.copyfile('/scratch/dirac/dirac-architecture',
                 '/scratch/dirac/scripts/dirac-architecture')
except:
 logINFO( 'Failed to copy /scratch/dirac/dirac-architecture to ' + 
          '/scratch/dirac/scripts/dirac-architecture' )
 pass
### End test of dirac-architecture test
...
# Or is this HS06 x time? How to get that???
os.system( "%s -F -o /LocalSite/CPUTimeLeft=%s" % (configureScript, cliParams.jobCPUReq ) )
...
inProcessOpts .append( '-o MaxTotalJobs=%s' % cliParams.maxCycles )
...
for i in os.listdir( rootPath ):
  ...
  if os.path.isfile( cfg ) and ( cfg[-10:] == '.extra.cfg' ):
    extraCFG.append( open(cfg, 'r').read().replace('\n', ' ') )
 
### Start test of glexec fix 
#try:
# shutil.copyfile('/scratch/dirac/glexecComputingElement.py',
#                 '/scratch/dirac/DIRAC/Resources/Computing/glexecComputingElement.py')
#except:
# logINFO( 'Failed to copy /scratch/dirac/glexecComputingElement.py to ' + 
#          '/scratch/dirac/DIRAC/Resources/Computing/glexecComputingElement.py' )
# pass
### End test of glexec fix

### Start test of nagios fix 
#try:
# shutil.copyfile('/scratch/dirac/UploadSAMLogs.py',
#                 '/scratch/dirac/LHCbDIRAC/SAMSystem/Modules/UploadSAMLogs.py')
## shutil.copyfile('/scratch/dirac/NagiosConnector.py',
##                 '/scratch/dirac/LHCbDIRAC/Core/Utilities/NagiosConnector.py')
#except:
# logINFO( 'Failed to copy /scratch/dirac/UploadSAMLogs.py ' +
#          '/scratch/dirac/LHCbDIRAC/SAMSystem/Modules/UploadSAMLogs.py (or NagiosConnector.py?)')
# pass
### End test of nagios fix
